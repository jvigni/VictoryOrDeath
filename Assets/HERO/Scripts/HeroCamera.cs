...
public class WoWFreeOrbitCamera : MonoBehaviour
{
    ...
    [SerializeField] private float heightOffset = 2f;       // Height offset from the target
    [SerializeField] private float horizontalSpeed = 100f;  // Speed of horizontal rotation
    [SerializeField] private float verticalSpeed = 80f;     // Speed of vertical rotation
    [SerializeField] private float minPitch = -20f;         // Minimum vertical angle
    [SerializeField] private float maxPitch = 80f;          // Maximum vertical angle
    ...
    void LateUpdate()
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            // Adjust yaw and pitch based on mouse input and respective speeds
        ...
        Vector3 targetPosition = hero.position + new Vector3(0, heightOffset, 0);
